...
def read_file(file):
    tree=ET.parse(r'../original datasets/Old Bailey/sessionsPapers/%s'%file)
    root=tree.getroot()
...
def write_csv(file):
    ...
    dataframe.to_csv("../evaluation datasets/Old Bailey_new/%s"%file,index=False,sep='\t')
    
if __name__ == "__main__":
    path='../original datasets/Old Bailey/sessionsPapers'
